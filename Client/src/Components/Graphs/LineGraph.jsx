...
useEffect(()=>{
  ...
  const averageIntensityValues = topics.map(
    (topic) => parseInt(groupedData[topic].intensitySum / groupedData[topic].count)
  );
  ...
  <div className="flex flex-col gap-4">
    ...
    <h1 className="font-bold text-gray-800">Sector</h1> - <Select className="w-[200px]" onChange={handleSectorChange} value={Selected}> 
